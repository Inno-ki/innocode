...
export default function Home() {
  ...
  return (
    <main className="fixed inset-0 flex flex-col pt-16">
      <AnimatePresence mode="wait">
        {status === "initial" ? (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="mx-auto flex h-full w-full max-w-7xl flex-col items-center px-4 pt-8 sm:pt-12"
          >
            ...
            <p className="mt-4 max-w-xl text-center text-base leading-relaxed text-gray-600 sm:text-lg">
              Nutze die Power von KI, um deine App-Ideen sofort Realität werden
              zu lassen. Ohne Code. Ohne Komplexität.
            </p>
                  ...
                  {[
                    {
                      ...
                      prompt:
                        "Erstelle einen Emoji-Generator mit Gesichtsausdrücken",
                    },
                    {
                      icon: "📝",
          ...
          >
            <div className="flex flex-1">
              ...
              <div className="flex w-[350px] flex-col border-r border-gray-200 bg-white">
                <div className="flex-1 overflow-y-auto p-4" data-chat-container>
                        ...
                        <Tooltip.Trigger asChild>
                          <button
                            ...
                            onClick={async () => {
                              ...
                              toast.success(
                                "Deine App wurde veröffentlicht und in dein Clipboard kopiert!",
                                {
