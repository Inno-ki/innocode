export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in InnoCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in InnoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in InnoCode.",
  ...
  "dialog.server.description": "Switch which InnoCode server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "InnoCode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking InnoCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking InnoCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating InnoCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating InnoCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update InnoCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update InnoCode",
  "wsl.onboarding.opencodeReadyIn": "InnoCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "InnoCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install InnoCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install InnoCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "InnoCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before InnoCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "InnoCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen InnoCode.",
  ...
  "toast.update.description": "A new version of InnoCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the InnoCode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, InnoCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "InnoCode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the InnoCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for InnoCode",
  ...
  "settings.general.row.appearance.description": "Customise how InnoCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether InnoCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how InnoCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when InnoCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of InnoCode.",
