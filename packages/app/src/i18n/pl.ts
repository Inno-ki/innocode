export const dict = {
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: InnoCode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer InnoCode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.colorScheme.description":
    "Wybierz, czy InnoCode ma używać motywu systemowego, jasnego czy ciemnego",
