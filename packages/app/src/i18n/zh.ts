...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "InnoCode 提供的免费模型",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 InnoCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 InnoCode 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 InnoCode 服务器。",
  ...
  "toast.update.description": "InnoCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 InnoCode 团队",
  ...
  "sidebar.gettingStarted.line1": "InnoCode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 InnoCode 服务器。",
  ...
  "settings.general.row.language.description": "更改 InnoCode 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 InnoCode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 InnoCode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 InnoCode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 InnoCode 启动时自动检查更新",
