    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://innocode.io/docs"),
            text: "InnoCode Documentation",
          }),
          await MenuItem.new({
            action: () => openUrl("https://innocode.io/discord"),
            text: "Support Forum",
          }),
          await PredefinedMenuItem.new({
            item: "Separator",
          ...
          await MenuItem.new({
            action: () =>
              openUrl("https://github.com/Inno-ki/innocode/issues/new?template=feature_request.yml"),
            text: "Share Feedback",
          }),
          await MenuItem.new({
            action: () =>
              openUrl("https://github.com/Inno-ki/innocode/issues/new?template=bug_report.yml"),
            text: "Report a Bug",
          }),
        ],
      }),
