...
const TIPS: Tip[] = [
  ...
  "Create {highlight}innocode.json{/highlight} for server settings, and {highlight}tui.json{/highlight} for TUI",
  "Place TUI settings in {highlight}~/.config/innocode/tui.json{/highlight} for global config",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/inno-ki/innocode{/highlight} in a container",
