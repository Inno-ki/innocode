...
Crear `.innocode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración InnoCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su InnoCode [config](/docs/config):
...
- Por proyecto: `.innocode/commands/`
...
innocode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
