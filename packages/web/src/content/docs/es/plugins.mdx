...
import type { Plugin } from "@innocode/plugin"
...
import { type Plugin, tool } from "@innocode/plugin"
...
Niveles: `debug`, `info`, `warn`, `error`. Consulte la [documentación del SDK](https://innocode.io/docs/sdk) para obtener más detalles.
