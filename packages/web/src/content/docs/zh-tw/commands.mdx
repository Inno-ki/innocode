...
您 可以透過 innocode 設定或透過在 `commands/` 目錄中建立 markdown 檔案來新增自定義指令。

---

### JSON

在 innocode [設定](/docs/config) 中使用 `command` 選項：
...
- 全域：`~/.config/innocode/commands/`
- 每個專案：`.innocode/commands/`
...
innocode 包含 `/init`、`/undo`、`/redo`、`/share`、`/help` 等內建指令； [了解更多](/docs/tui#commands)。
