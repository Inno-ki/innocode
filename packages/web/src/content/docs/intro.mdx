...
- **Using Scoop on Windows**
  ...
  ```powershell
  scoop install https://github.com/Inno-ki/scoop-bucket/innocode.json
  ```
...
You can also grab the binary from the [Releases](https://github.com/Inno-ki/innocode/releases).
