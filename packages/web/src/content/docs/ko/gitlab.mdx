...
여기에서 우리는 opencode에 대한 커뮤니티 생성 CI / CD 구성품을 사용하고 있습니다. [nagyv/gitlab-innocode](https://gitlab.com/nagyv/gitlab-innocode).
...
- ** 최소 설정**: CI 구성 요소는 opencode를 배경으로 설정하면 innocode 구성과 초기 프롬프트를 만들 필요가 있습니다.
...
코멘트에 Mention `@innocode`, opencode는 GitLab CI 파이프라인 내에서 작업을 실행합니다.
