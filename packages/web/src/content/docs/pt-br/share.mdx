---
title: Compartilhar
description: Compartilhe suas conversas do innocode.
---

O recurso de compartilhamento do innocode permite que você crie links públicos para suas conversas do innocode, para que você possa colaborar com colegas de equipe ou obter ajuda de outros.
...
Quando você compartilha uma conversa, o innocode:

1. Cria uma URL pública única para sua sessão
2. Sincroniza seu histórico de conversas com nossos servidores
3. Torna a conversa acessível através do link compartilhável — `innocode.io/s/<share-id>`

---

## Compartilhamento

O innocode suporta três modos de compartilhamento que controlam como as conversas são compartilhadas:

---

### Manual (padrão)

Por padrão, o innocode usa o modo de compartilhamento manual. As sessões não são compartilhadas automaticamente, mas você pode compartilhá-las manualmente usando o comando `/share`:
...
Para impor isso em sua equipe para um determinado projeto, adicione-o ao `innocode.json` em seu projeto e faça o check-in no Git.
...
[Saiba mais](/docs/enterprise) sobre como usar o innocode em sua organização.
