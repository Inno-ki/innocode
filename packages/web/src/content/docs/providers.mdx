---
title: Providers
description: InnoGPT is the only supported provider in InnoCode.
---
...
1. Add your InnoGPT API key using the `/connect` command.
2. Use InnoGPT models in your InnoCode config.
...
1. Run the `/connect` command in the TUI, select **InnoGPT**, and head to [app.innogpt.de](https://app.innogpt.de).
...
To use [Scaleway Generative APIs](https://www.scaleway.com/en/docs/generative-apis/) with InnoCode:
