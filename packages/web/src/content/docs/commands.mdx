...
Custom commands are in addition to the built-in commands like `/init`, `/undo`, `/redo`, `/help`. [Learn more](/docs/tui#commands).
...
Create `.innocode/commands/test.md`:

```md title=".innocode/commands/test.md"
---
...
You can add custom commands through the InnoCode config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your InnoCode [config](/docs/config):

```json title="innocode.jsonc" {4-12}
{
...
- Global: `~/.config/innocode/commands/`
- Per-project: `.innocode/commands/`

```markdown title="~/.config/innocode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".innocode/commands/component.md"
---
...
```md title=".innocode/commands/create-file.md"
---
...
```md title=".innocode/commands/analyze-coverage.md"
---
...
```md title=".innocode/commands/review-changes.md"
---
...
```md title=".innocode/commands/review-component.md"
---
...
innocode includes several built-in commands like `/init`, `/undo`, `/redo`, `/help`; [learn more](/docs/tui#commands).
