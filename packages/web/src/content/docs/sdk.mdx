...
```bash
npm install @@innogpt/innocode/sdk
```
...
```javascript
import { createOpencode } from "@@innogpt/innocode/sdk"
...
```javascript
import { createOpencodeClient } from "@@innogpt/innocode/sdk"
...
```typescript
import type { Session, Message, Part } from "@@innogpt/innocode/sdk"
```
