...
Opret `.innocode/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem InnoCode-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din InnoCode [config](/docs/config):
...
- Globalt: `~/.config/innocode/commands/`
- Pr. projekt: `.innocode/commands/`
...
innocode indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
