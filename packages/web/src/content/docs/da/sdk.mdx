...
Brug den til at bygge integrasjoner og kontrollere innocode programmatisk.
...
Opret en forekomst av innocode:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `innocode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av innocode, kan du oprete en klientforekomst for at koble til den:
