...
description: Opret værktøjer, som LLM kan kalde innocode ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med innocodes [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.innocode/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/innocode/tools/`.
