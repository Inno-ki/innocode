...
Kreiraj `.innocode/commands/test.md`:
...
Možete dodati prilagođene komande kroz InnoCode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom InnoCode [config](/docs/config):
...
- Globalno: `~/.config/innocode/commands/`
- Po projektu: `.innocode/commands/`
...
InnoCode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
