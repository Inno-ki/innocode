...
Možete definirati MCP servere u vašoj [InnoCode Config](https://innocode.io/docs/config/) pod `mcp`. Dodajte svaki MCP sa jedinstvenim imenom. Možete se pozvati na taj MCP po imenu kada tražite LLM.
