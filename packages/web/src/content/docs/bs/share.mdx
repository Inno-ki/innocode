---
title: Dijeljenje
description: Dijelite InnoCode razgovore javnim linkovima.
---

InnoCode opcija dijeljenja vam omogucava da kreirate javne linkove za razgovore. Tako lakse saradujete s timom ili trazite pomoc od drugih.
...
Kada podijelite razgovor, InnoCode:

1. Kreira jedinstveni javni URL za vasu sesiju
2. Sinhronizuje historiju razgovora na nase servere
3. Cini razgovor dostupnim preko linka za dijeljenje — `innocode.io/s/<share-id>`

---

## Dijeljenje

InnoCode podrzava tri nacina dijeljenja koji odreduju kako se razgovori dijele:

---

### Ručno (zadano)

Po defaultu, InnoCode koristi rucni nacin dijeljenja. Sesije se ne dijele automatski, ali ih mozete rucno podijeliti komandom `/share`:
...
Da ovo vazi za cijeli tim u odredenom projektu, dodajte postavku u projektni `innocode.json` i commitujte u Git.
...
[Saznajte vise](/docs/enterprise) o koristenju innocode u organizaciji.
