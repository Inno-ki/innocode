---
title: TUI
description: Korištenje korisničkog interfejsa InnoCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

InnoCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje InnoCode pokreće TUI za trenutni direktorij.
...
Kada koristite InnoCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u InnoCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz InnoCode. _Aliases_: `/quit`, `/q`
...
Možete prilagoditi TUI ponašanje putem vašeg InnoCode konfiguracionog fajla.
