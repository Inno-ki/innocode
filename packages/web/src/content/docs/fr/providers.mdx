...
{
  "$schema": "https://innocode.ai/config.json",
  "provider": {
    "anthropic": {
      "options": {
...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez innocode et dirigez-vous vers [innocode.ai/auth](https://innocode.ai/auth).
