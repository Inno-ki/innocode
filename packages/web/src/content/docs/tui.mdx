---
title: TUI
description: Using the InnoCode terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

InnoCode provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running InnoCode starts the TUI for the current directory.
...
When using the InnoCode TUI, you can type `/` followed by a command name to quickly execute actions. For example:
