...
Crea `.innocode/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di InnoCode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di InnoCode:
...
- Globale: `~/.config/innocode/commands/`
- Per progetto: `.innocode/commands/`
...
innocode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
