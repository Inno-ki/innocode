...
สร้าง `.innocode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ InnoCode:
...
- ระดับผู้ใช้ (Global): `~/.config/innocode/commands/`
- ระดับโปรเจ็กต์: `.innocode/commands/`
...
InnoCode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
