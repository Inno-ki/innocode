---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez innocode.
---
...
InnoGPT to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół innocode.

:::note
InnoGPT is currently in beta.
:::

Zen działa jak każdy inny dostawca innocode. Logujesz się do InnoGPT i dostajesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z innocode.
:::
...
InnoGPT to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

InnoGPT działa jak każdy inny dostawca innocode.

1. Logujesz się do **<a href={console}>InnoGPT</a>**, dodajesz swoje rozliczenia
   szczegóły i skopiuj klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz InnoGPT i wklejasz klucz API.
...
[Identyfikator modelu](/docs/config/#models) w konfiguracji innocode
używa formatu `innocode/<model-id>`. Na przykład w przypadku Kodeksu GPT 5.2 zrobiłbyś to
użyj `innocode/gpt-5.2-codex` w swojej konfiguracji.
...
- GLM 4.7 Free jest dostępny na platformie innocode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Kimi K2.5 Free jest dostępny na innocode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- MiniMax M2.1 Free jest dostępny na platformie innocode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Big Pickle to ukryty model, który jest bezpłatny w innocode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
...
4. Nie **nie blokuj**, umożliwiając używanie go z dowolnym innym agentem kodującym. I zawsze pozwalaj na korzystanie z innocode dowolnego innego dostawcy.
