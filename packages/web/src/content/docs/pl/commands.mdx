...
Utwórz `.innocode/commands/test.md`:
...
Możesz zdefiniować polecenia w `innocode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji innocode:
...
- Globalnie: `~/.config/innocode/commands/`
- Na projekt: `.innocode/commands/`
...
innocode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
