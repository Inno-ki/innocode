---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala innocode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

innocode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie innocode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI innocode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do innocode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij innocode. _Aliasy_: `/quit`, `/q`
...
Możesz dostosować zachowanie TUI za pomocą pliku konfiguracyjnego innocode.
