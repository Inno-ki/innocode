---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące innocode.
---

Funkcja udostępniania innocode umożliwia tworzenie publicznych linków do konwersacji innocode, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, innocode:

1. Tworzy unikalny publiczny adres URL sesji
2. Synchronizuje historię rozmów z naszymi serwerami
3. Udostępnia rozmowę za pośrednictwem łącza do udostępniania — `innocode.io/s/<share-id>`

---

## Udostępnianie

innocode obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie innocode korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `innocode.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu innocode w Twojej organizacji.
