...
يوجد نوعان من الوكلاء في InnoCode: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي InnoCode مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي InnoCode مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي InnoCode مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `innocode.json`:
...
- عام: `~/.config/innocode/agents/`
- لكل مشروع: `.innocode/agents/`
...
إذا لم يتم تحديد temperature، يستخدم InnoCode القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات InnoCode العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات InnoCode الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [InnoGPT](/docs/zen)، فستستخدم `innocode/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `innocode models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/anomalyco/innocode).
:::
