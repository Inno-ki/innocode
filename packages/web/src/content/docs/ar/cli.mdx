...
يشغّل هذا خادم HTTP يوفّر وصولا عبر API لوظائف innocode دون واجهة TUI. اضبط `OPENCODE_SERVER_PASSWORD` لتفعيل مصادقة HTTP الأساسية (اسم المستخدم الافتراضي `innocode`).
...
يشغّل هذا خادم HTTP ويفتح متصفح ويب للوصول إلى InnoCode عبر واجهة ويب. اضبط `OPENCODE_SERVER_PASSWORD` لتفعيل مصادقة HTTP الأساسية (اسم المستخدم الافتراضي `innocode`).
...
| `OPENCODE_SERVER_USERNAME`            | string  | تجاوز اسم مستخدم المصادقة الأساسية (الافتراضي `innocode`) |
