...
Du kan definere MCP-servere i [InnoCode Config](https://innocode.io/docs/config/) under `mcp`. Legg til hver MCP med et unikt navn. Du kan referere til den MCP ved navn når du spør LLM-en.
