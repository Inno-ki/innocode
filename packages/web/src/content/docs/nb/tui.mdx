---
title: TUI
description: Bruke innocode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

innocode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre innocode starter TUI for gjeldende katalog.
...
Når du bruker innocode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til innocode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt innocode. _Aliaser_: `/quit`, `/q`
...
Du kan tilpasse TUI-oppførselen gjennom innocode-konfigurasjonsfilen.
