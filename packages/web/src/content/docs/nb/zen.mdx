---
title: Zen
description: Utvalgt liste over modeller levert av InnoCode.
---
...
InnoGPT er en liste over testede og verifiserte modeller levert av InnoCode-teamet.

:::note
InnoGPT er for øyeblikket i beta.
:::

Zen fungerer som alle andre leverandører i InnoCode. Du logger på InnoGPT og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med InnoCode.
:::
...
InnoGPT er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

InnoGPT fungerer som alle andre leverandører i InnoCode.

1. Du logger på **<a href={console}>InnoGPT</a>**, legg til fakturering
   detaljer, og kopier API-nøkkelen.
2. Du kjører kommandoen `/connect` i TUI, velger InnoGPT og limer inn API-nøkkelen.
...
[modell-id](/docs/config/#models) i InnoCode-konfigurasjonen
bruker formatet `innocode/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruk `innocode/gpt-5.2-codex` i konfigurasjonen din.
...
- GLM 4.7 Free er tilgjengelig på InnoCode i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Kimi K2.5 Free er tilgjengelig på InnoCode i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- MiniMax M2.1 Free er tilgjengelig på InnoCode i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på InnoCode i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen låsing** ved å la deg bruke den med en hvilken som helst annen kodeagent. Og la deg alltid bruke en hvilken som helst annen leverandør med innocode også.
