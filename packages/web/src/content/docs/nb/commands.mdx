...
Opprett `.innocode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom InnoCode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i InnoCode [config](/docs/config):
...
- Per prosjekt: `.innocode/commands/`
...
InnoCode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
