...
Agentferdigheter lar InnoCode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går innocode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
innocode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `innocode.json`:
