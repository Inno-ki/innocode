---
title: Teilen
description: Teile InnoCode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu InnoCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht InnoCode Folgendes:

1. Erstellt eine eindeutige oeffentliche URL fuer deine Sitzung
2. Synchronisiert den Verlauf auf unsere Server
3. Stellt die Unterhaltung unter `innocode.io/s/<share-id>` bereit

---

## Teilen

InnoCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt InnoCode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`innocode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du innocode in deiner Organisation einsetzt.
