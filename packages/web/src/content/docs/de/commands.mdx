...
Erstellen Sie `.innocode/commands/test.md`:
...
Sie können benutzerdefinierte Befehle über die InnoCode-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem InnoCode [config](/docs/config):
...
InnoCode enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
