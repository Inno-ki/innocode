---
title: TUI
description: Arbeite mit InnoCode in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

InnoCode bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet InnoCode die TUI im aktuellen Verzeichnis.
...
In der InnoCode-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Add a provider to InnoCode. Allows you to select from available providers and add their API keys.
...
Exit InnoCode. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your InnoCode config file.
