...
InnoCode verfügt über eine Liste von Tastenkombinationen, die Sie über die InnoCode-Konfiguration anpassen können.
...
InnoCode verwendet für die meisten Keybinds einen `leader`-Schlüssel. Dies vermeidet Konflikte in Ihrem Terminal.
...
Die Eingabeaufforderungseingabe der InnoCode-Desktop-App unterstützt gängige Readline/Emacs-style-Verknüpfungen zum Bearbeiten von Text. Diese sind integriert und derzeit nicht über `innocode.json` konfigurierbar.
