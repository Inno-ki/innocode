...
Mit InnoCode kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet InnoCode das `innocode`-Theme.
...
InnoCode liefert mehrere eingebaute Themes mit.
...
- InnoCode optisch ans Terminal anpassen wollen
...
InnoCode unterstuetzt ein flexibles JSON-basiertes Theme-System.
