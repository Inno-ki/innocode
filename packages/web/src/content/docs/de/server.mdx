...
Der Benutzername ist standardmaessig `innocode`, kann aber mit `OPENCODE_SERVER_USERNAME` ueberschrieben werden. Das gilt fuer `innocode serve` und `innocode web`.
