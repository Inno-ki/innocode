---
title: TUI
description: 使用 innocode 终端用户界面。
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

innocode 提供交互式终端介面或 TUI，以便使用 LLM 处理您的专案。

执行innocode启动当前目录的TUI。
...
使用 innocode TUI 时，您可以输入 `/` 后跟命令名称来快速执行操作。例如：
...
将提供商添加到 innocode。你可以从可用提供商中选择，并添加它们的 API 密钥。
