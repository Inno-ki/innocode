---
title: Özel Araçlar
description: LLM'un innocode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. innocode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.innocode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/innocode/tools/` içine yerleştirerek.
