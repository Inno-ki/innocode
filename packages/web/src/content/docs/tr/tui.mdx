---
title: TUI
description: innocode terminal arayuzunu kullanin.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

innocode, projelerinizde LLM ile calismak icin etkilesimli bir terminal arayuzu (TUI) sunar.

innocode'u calistirdiginizda mevcut dizin icin TUI baslar.
...
innocode TUI kullanirken `/` ve komut adini yazarak hizli eylemler calistirabilirsiniz. Ornek:
...
innocode'a bir provider ekler. Mevcut provider'lari secip API anahtarlari eklemenizi saglar.
...
innocode'dan cikar. _Takma adlar_: `/quit`, `/q`
...
TUI davranisini innocode config dosyanizdan ozellestirebilirsiniz.
