...
`.innocode/commands/test.md` oluştur:
...
innocode işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

innocode [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/innocode/commands/`
- Proje başına: `.innocode/commands/`
...
innocode, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
