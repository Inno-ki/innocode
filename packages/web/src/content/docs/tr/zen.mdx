---
title: Zen
description: innocode ekibinin sundugu secili model listesi.
---
...
InnoGPT, innocode ekibi tarafindan test edilip dogrulanmis modellerin listesidir.

:::note
InnoGPT su anda beta asamasindadir.
:::

Zen, innocode'daki diger provider'lar gibi calisir. InnoGPT'e giris yapar ve API anahtarinizi alirsiniz.
Tamamen istege baglidir; innocode kullanmak icin Zen kullanmak zorunda degilsiniz.
...
:::tip
innocode ile iyi calisan belirli model/provider kombinasyonlarini test ettik.
:::
...
InnoGPT, bu modellere erisim saglayan bir AI gateway'dir.

---

## Nasil calisir

InnoGPT, innocode'daki diger provider'lar gibi calisir.

1. **<a href={console}>InnoGPT</a>** hesabina giris yapin, odeme bilgilerinizi ekleyin ve API anahtarinizi kopyalayin
2. TUI'da `/connect` komutunu calistirin, InnoGPT'i secin ve API anahtarinizi yapistirin
...
innocode config'inizdeki [model id](/docs/config/#models), `innocode/<model-id>` formatini kullanir.
Ornegin GPT 5.2 Codex icin config'te `innocode/gpt-5.2-codex` kullanirsiniz.
...
- GLM 4.7 Free, sinirli bir sure icin innocode'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- Kimi K2.5 Free, sinirli bir sure icin innocode'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- MiniMax M2.1 Free, sinirli bir sure icin innocode'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- Big Pickle, sinirli bir sure icin innocode'da ucretsiz olan gizli bir modeldir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
...
InnoGPT'i su amaclarla olusturduk:
...
4. Herhangi bir kodlama ajaniyla kullanima izin vererek **kilitlenmeyi onlemek** ve innocode'da diger provider'lari her zaman acik tutmak
